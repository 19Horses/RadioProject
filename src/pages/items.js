...
export const djs = [
  ...
  },
  {
    ...
    tracklist: [
      ...
      { title: "Rhythm In Your Mind (Steve Conry & Takashi Nakazato Remix)", artist: "STR4TA" },
      { title: "Love Is Gonna Lift You Up (Julio Bashmore Remix)", artist: "Bobby Womack" },
      { title: "Tied Up (Kenny Dope Remix)", artist: "Moon Boots, Steven Klavier, Kenny Dope" },
      { title: "Standing Right Here (John Morales M&M Main Mix)", artist: "Mannix feat. Dina Vass" },
      { title: "The Calling (Ralf GUM Radio Edit)", artist: "Ralf Gum, Joseph Junior" },
      { title: "Truth Don Die (Kerri Chandler Remix)", artist: "Femi Kuti" },
      { title: "Let the Sun Shine In", artist: "Sons and Daughters of Lite" },
      ...
      { startTime: "3276", title: "RADIO (b)" },
      { title: "Rise & Shine (Original - Vinyl edit)", artist: "Esteban Adame" },
      { title: "Birds, Pt. I", artist: "Chassol" },
      { title: "IM SO STUPID IM CLEVER", artist: "RAZA" },
      { title: "Love Is Forever", artist: "Blaze" },
      { title: "Babalonia", artist: "Ricardo Marrero & The Group" },
      { title: "Get You (Alton Miller Remix)", artist: "James Curd, Osunlade, Alton Miller" },
      {
        title: "Sunlight",
        artist: "Infiniti",
      },
      { title: "Emberfall", artist: "Loxodrome" },
      { title: "Souffles H (King St. Club Mix by Masters at Work)", artist: "Kyoto Jazz Massive" },
