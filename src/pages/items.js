...
export const djs = [
  ...
  },
  {
    ...
    title3: "Musician",
    description:
      "<span><a href='https://www.instagram.com/radio__project/'>RADIO Project</a> spoke with <b>3D modeller</b></span> <a href='https://www.instagram.com/michael.adlj/'>HOWDOGIRLSSLEEP</a><span>. They spoke about...</span>",
    mixId: "https://d2rmb5ql8vpbx8.cloudfront.net/michael-rp.wav",
    releaseDate: "25/7/25",
    length: "1 Hour 26 Minutes",
    genre: "AMBIENT HARDGROOVE",
    chapters: [
      { startTime: 0, title: "RADIO (a)" },
      { startTime: 1680, title: "PROJECT" },
      { startTime: 3306, title: "RADIO (b)" },
    ],
    tracklist: [
      { startTime: "0", title: "RADIO (a)" },
