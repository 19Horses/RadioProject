...
export const djs = [
  {
    ...
    "tracklist": [
      ...
      { "title": "HASYMO_RESCUE (tasfet_rmx)", "artist": "Tasfet"},
      { "title": "Television", "artist": " AG Cook"},
      ...
      { "title": "Club Stranger (Nguzunguzu Remix)", "artist": "Nguzunguzu"},
      { "title": "TF DUMMY NUMBER ZERO ZERO ZERO ZERO ZERO ZERO ZERO ZERO", "artist": "elysia"},
      ...
      { "title": "Teenage Dream", "artist": "Katy Perry, AG Cook"},
      { "title": "Yonderboi", "artist": "Junkie XL"},
      { "title": "Feels So Good", "artist": "benoviolence"},
      { "title": "Dead Long Time", "artist": "Nguzunguzu"},
      { "title": "Overly", "artist": "Playboi Carti"},
      { "title": "Mr Me Too", "artist": "Clipse"},
      { "title": "Last One To Remain", "artist": "Pandatone"},
